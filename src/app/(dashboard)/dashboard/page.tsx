...
const recentActivity = [
  { title: "Escala Gerada", desc: "Escala para Evento 'Verão 2024' criada via IA", time: "2h atrás", status: "Novo" },
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Monitoramento em tempo real das operações de Controle de Acesso.</p>
      </div>
              ...
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center justify-between p-4 rounded-lg border border-border/50 bg-muted/30">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-medium">Operação Arena Verão</p>
